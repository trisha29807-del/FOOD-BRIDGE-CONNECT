...
class DonateFoodActivity : AppCompatActivity() {
    ...
    private fun setupListFoodButton() {
        btnListFood.setOnClickListener {
            ...
            val foodType = spinnerFoodType.selectedItemPosition
    ...
    private fun setupBottomNav() {
        ...
        bottomNav.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_browse -> {
                    Toast.makeText(this, "Browse coming soon!", Toast.LENGTH_SHORT).show(); true
                }
                R.id.nav_fssai -> {
                    Toast.makeText(this, "FSSAI coming soon!", Toast.LENGTH_SHORT).show(); true
                }
                R.id.nav_profile -> {
